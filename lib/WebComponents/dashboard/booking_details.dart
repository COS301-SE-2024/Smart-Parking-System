...
class BookingDetails extends StatelessWidget {
  ...
  void _showEditDialog(BuildContext context, String bookingId, Map<String, dynamic> data) {
    ...
    final TextEditingController _dateController = TextEditingController(text: data['date'] ?? '');
    final TextEditingController _timeController = TextEditingController(text: data['time'] ?? '');
